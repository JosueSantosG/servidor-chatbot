...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    exports.nlp.addAnswer('es', 'facultades.facultades', 'En total son siete facultades que son: \nCiencia del Mar\nSistemas y Telecomunicaciones\nCiencias de la Educación e Idiomas\nCiencias de la Ingeniería\nCiencias sociales y de la Salud \nCiencias administrativas\nCiencias Agrarias\n \nRecuerda que puedes consultarme más información sobre cada una de ellas.');
    exports.nlp.addAnswer('es', 'facultades.facultades', 'Hay siete facultades disponibles: \nCiencia del Mar\nSistemas y Telecomunicaciones\nCiencias de la Educación e Idiomas\nCiencias de la Ingeniería\nCiencias sociales y de la Salud \nCiencias administrativas\nCiencias Agrarias\n \nRecuerda que puedes consultarme más información sobre cada una de ellas.');
    ...
    exports.nlp.addAnswer('es', 'maestria.docs', 'Para el registro en línea necesitarás: hoja de vida, solicitud de admisión, senescyt*, cedula/votación y pago de inscripción. Puedes descargar las platillas aquí -> https://www.upse.edu.ec/postgrado/index.php/acuicultura');
    ...
    exports.nlp.addAnswer('es', 'maestria.costo', 'La maestría de Acuicultura tiene un arancel de $3700 dólares y matrícula de $300 dólares que dan un total de $4000 dólares. \n\nRecuerda que hay diferentes descuentos a la que puedes aplicar');
    ...
    exports.nlp.addAnswer('es', 'maestria.docsbio', 'Para el registro en línea necesitarás: hoja de vida, solicitud de admisión, senescyt*, cedula/votación y pago de inscripción. Puedes descargar las platillas aquí -> https://www.upse.edu.ec/postgrado/index.php/acuicultura');
    ...
    exports.nlp.addAnswer('es', 'maestria.costobio', 'La maestría de Biodiversidad y Cambio Climático tiene un arancel de $4000 dólares y matrícula de $0 dólares que dan un total de $4000 dólares. \n\nRecuerda que hay diferentes descuentos a la que puedes aplicar');
    ...
    exports.nlp.addAnswer('es', 'costo_maestria.costo_maestria', 'Varía dependiendo de la maestría que elijas. Por ejemplo, en la maestría de Tecnologías de la Información tiene un arancel de $5500 dólares y una matrícula de $300 dólares, lo que da un total de $5800 dólares. \n\nRecuerda que también hay diferentes descuentos a los que puedes aplicar.');
    ...
    exports.nlp.addDocument('es', 'link de inscripcion', 'inscripcion.inscripcion');
    exports.nlp.addDocument('es', 'que necesito para inscribirme', 'inscripcion.inscripcion');
    exports.nlp.addAnswer('es', 'inscripcion.inscripcion', 'Para inscribirte en una maestría puedes ir a este link y proporcionar tus datos: https://sga.upse.edu.ec/aplicacion/#/register-postgrados.');
    ...
    exports.nlp.addAnswer('es', 'subir_docs.subir_docs', 'Para subir tus documentos, comprobantes de pago o ver tus calificaciones, puedes hacerlo a través de la plataforma SGA -> https://sga.upse.edu.ec/aplicacion/');
    //TAG: PLATAFORMA_MOODLE
    exports.nlp.addDocument('es', 'plataforma de moodle', 'moodle.moodle');
    exports.nlp.addAnswer('es', 'moodle.moodle', 'Para ingresar a la plataforma Moodle puedes hacerlo aquí -> https://ava.upse.edu.ec/');
    //TAG: SOPORTE
    ...
    exports.nlp.addAnswer('es', 'soporte.soporte', 'Si presentas algún inconveniente, puedes comunicarte con el soporte de TICS en este enlace: http://www.upse.edu.ec/soporte/ o al correo: soporte@upse.edu.ec');
