...
Puedes consultar mas información haciendo click en una maestría, y luego en enviar.`);
        ...
        exports.nlp.addDocument('es', 'que documentos necesito para acuicultura', 'maestria.docs_acui');
        exports.nlp.addDocument('es', 'como hago para descargar la plantilla de acuicultura', 'maestria.docs_acui');
        exports.nlp.addDocument('es', 'hoja de vida acuicultura', 'maestria.docs_acui');
        exports.nlp.addAnswer('es', 'maestria.docs_acui', 'Para el registro en línea necesitarás: hoja de vida, solicitud de admisión, senescyt*, cedula/votación y pago de inscripción. Puedes descargar las plantillas <a href="https://www.upse.edu.ec/postgrado/index.php/acuicultura" target="_blank">aquí</a>.');
        ...
        exports.nlp.addAnswer('es', 'maestria.costo_acui', 'La maestría de Acuicultura tiene un arancel de $3700 dólares y matrícula de $300 dólares que dan un total de $4000 dólares. <br><br>Recuerda que hay diferentes descuentos a la que puedes aplicar');
  ...
  Puedes consultar mas información haciendo click en una maestría, y luego en enviar.`);
        ...
        exports.nlp.addDocument('es', 'que documentos necesito para la maestria electronica y automatizacion', 'maestria.docselect');
        exports.nlp.addDocument('es', 'como hago para descargar la plantilla de la maestria de electronica y automatizacion', 'maestria.docselect');
        exports.nlp.addDocument('es', 'hoja de vida de electronica y automatizacion', 'maestria.docselect');
        ...
        exports.nlp.addAnswer('es', 'maestria.costoelect', 'La maestría de <br> Electrónica y Automatización</br> tiene un arancel de $3800 dólares y matrícula de $230 dólares que dan un total de $4030 dólares. <br><br>Recuerda que hay diferentes descuentos a la que puedes aplicar');
